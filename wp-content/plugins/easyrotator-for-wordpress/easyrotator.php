...
Text Domain: easyrotator-for-wordpress
...
class EasyRotator
{
	...
	function hook_admin_init()
	{
        ...
        if ($includeJQUICSS)
        {
            ...
            {
                wp_enqueue_style(  'jquery-ui-style', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/themes/smoothness/jquery-ui.css');
            }
            else
            {
...
class EasyRotatorWidget extends WP_Widget
{
	function EasyRotatorWidget() 
	{
		...
		parent::__construct('easyrotator_widget', 'EasyRotator Rotator', $widget_options, $control_options);
	}
