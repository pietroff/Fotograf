...
if(isset($_POST['submit-wmp-shortcode'])){
	...
	$shortcodeDataInput = array(
						   ...
						   'wmlo_is_generic'			=> isset($_POST['wmlo_is_generic'])?$_POST['wmlo_is_generic']:'no',
						   ...
						   /*'wmlo_product_category'		=> $_POST['wmlo_product_category'], removed in VERSION 1.7*/
						   ...
						   'wmlo_custom_query'			=> $_POST['wmlo_custom_query']
						   );
			...
			<table cellspacing="0" class="wp-list-table widefat fixed bookmarks">
                ...
                <tbody>
                    ...
                    <tr <?php echo $sn % 2 == 0?'':'class="alternate"'; ?>>
                        ...
                        <td><a href="admin.php?page=wmlp_shortcodes&edit_shortcode_key=<?php echo $key; ?>">Edit</a> | <a onclick="if (!confirm('Are you sure ?')){return false;}" href="admin.php?page=wmlp_shortcodes&delete_shortcode_key=<?php echo $key; ?>">Delete</a></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php else: ?>
                    <tr>
