        ...
        <td>
            <form action="admin.php?page=wmlp_shortcodes" id="add_edit_shortcode_form" method="post" enctype="multipart/form-data">
                ...
                <table class="wmlp_form">
							...
							if (!empty($taxonomy_objects)):
								foreach ($taxonomy_objects as $taxonomy_slug => $taxonomy_object):
									if ($taxonomy_object->public == 1 && wp_count_terms( $taxonomy_slug ) > 0): ?>
										<tr id="" class="notForGeneric taxonomy checklist hidden posttype_taxonomies <?php echo $post_type ?>_taxonomies_holder">
                    ...
                    <?php /*?><tr id="post_category_holder" class="hidden notForGeneric">
                    	<td>Post Category</td>
                        <td>
                    ...
                    <tr id="" class="hidden notForGeneric posttype_taxonomies page_taxonomies_holder">
                    	<td>Child Page of</td>
                        <td>
                    ...
                    <tr>
						...
						<td>
                        	<select name="wmlo_use_lazyload" class="required medium">
                            	<option value=""> -- Select -- </option>
                                <option value="no" <?php echo wmlp_fill_up_form($shortcodeDetails, 'wmlo_use_lazyload', 'no'); ?>>No</option>
                                <option value="yes" <?php echo wmlp_fill_up_form($shortcodeDetails, 'wmlo_use_lazyload', 'yes'); ?>>Yes</option>
                            </select><br/>
