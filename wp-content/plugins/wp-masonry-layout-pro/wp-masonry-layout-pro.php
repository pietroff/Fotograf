<?php
/* 
Plugin Name: WP Masonry Layout Pro
...
*/
include('wmlp_updater.php');
include('plugin_interface.php');
include('extended_interface.php');
include('wmlp_layout_functions.php');
register_activation_hook( __FILE__, 'wmlp_activate' );
?>